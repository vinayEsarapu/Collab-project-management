            ...
            <div className="grid gap-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  disabled={isCreatingTask}
                  className="w-full resize-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-600 focus:border-indigo-400/50 focus:ring-2 focus:ring-indigo-400/10 disabled:cursor-not-allowed disabled:opacity-60"
                />
              </div>
              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <select
                    ...
                    disabled={isCreatingTask}
                    className="w-full rounded-xl border border-white/10 bg-slate-900 px-4 py-3 text-sm text-white outline-none focus:border-indigo-400/50 disabled:cursor-not-allowed disabled:opacity-60"
                  >
